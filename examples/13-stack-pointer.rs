...
fn print_safe_stack_size() {
    ...
    // Corrected logic to calculate used stack size
    let used_stack = current_sp - stack_low;

    info!("Stack Start: {}, Stack End: {}, Current SP: {}, Used Stack: {} bytes",
          stack_high, stack_low, current_sp, used_stack);
    if current_sp > stack_high {
